...
$(document).ready(function(){
    ...
    $( '.swipebox' ).swipebox( {
        ...
        beforeOpen: function() { $('.header-chambre').slideUp('fast');}, // called before opening
        afterClose: function() {$('.header-chambre').slideDown('fast');} // called after closing
    } );
    ...
    $.scrollIt({
        ...
        activeClass: 'selected-scroll', // class given to the active nav element
